...
{
?>
    <center><h5>Mail Server Down. So Your Entry is Not Inserted. Please Try after some time</h5>
    echo "<a href="<?php redirect(base_url().'Admin/LeadGeneration');?>">Go Back</>;</center>
<?php
}
		}
		else{
...
public function leaddelete($id){
   ...
   if($data){
	...
	public function saveUser(){
		if($this->session->userdata('login')){
	    $agentArray=array('name'=>$this->input->post('name'),
	                      'email'=>$this->input->post('email'),
