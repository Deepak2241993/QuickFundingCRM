					...
					<div class="col-xl-12 mx-auto">
                                       ...
                                       <div class="col-xl-6 mb-3">
										<label class="form-label">Agent Name <span class="text-danger">*</span></label>
										 <select class="form-select mb-3" aria-label="Default select example" name="agent_name" style="margin: 8px;" required>
													...
													<option value="<?=$agent->id ?>" <?php if($editdata->agent_name == $agent->id){ echo "selected";} ?>><?=$agent->name ?></option>
												<?php } ?>
                        ...
                        <tbody>
						  ...
						  <tr>
                            ...
                            <td><div class="row"><div class="col-xl-3 mb-3"><span>Make:</span><input type="text" name="car_make1" value="<?=$editdata->car_make1 ?>" class="form-control"></div><div class="col-xl-3 mb-3"><span>Year:</span><input type="text" name="car_year1" value="<?=$editdata->car_year1 ?>" class="form-control"></div></div></td>
                            <td><div class="row"><div class="col-xl-4 mb-3"><span>Approx. Value:</span><input type="text" name="approxvalue__car1" value="<?=$editdata->approxvalue_car1 ?>" class="form-control"></div><div class="col-xl-4 mb-3"><span>Type:</span>
						...
						<div class="col-xl-4 mb-3"><span>Car variant:</span>
                            <input type="text" name="car_variant_car1" value="<?=$editdata->car_variant_car1 ?>" class="form-control"></div>
						</div></td>
                          </tr>
						  <tr>
                            <th scope="row">6</th>
                            <td>Car (type, model & year) <span class="text-danger">*</span></td>
                            <td><div class="row"><div class="col-xl-3 mb-3"><span>Make:</span><input type="text" name="car_make2"  value="<?=$editdata->car_make2 ?>" class="form-control"></div><div class="col-xl-3 mb-3"><span>Year:</span><input type="text"  value="<?=$editdata->car_year2 ?>" name="car_year2" class="form-control"></div></div></td>
                            <td><div class="row"><div class="col-xl-4 mb-3"><span>Approx. Value:</span><input type="text" name="approxvalue_car2" value="<?=$editdata->approxvalue_car2 ?>" class="form-control"></div><div class="col-xl-4 mb-3"><span>Type:</span>
						...
						<div class="col-xl-4 mb-3"><span>Car variant:</span>
                            <input type="text" name="car_variant_car2" value="<?=$editdata->car_variant_car2 ?>" class="form-control"></div>
						</div></td>
                          </tr>
						  <tr>
                            <th scope="row">7</th>
							...
							<div class="card-body">
								 <h6 class="mb-0 text-uppercase" style="color:#1493ee;">Home Loans:</h6>
									<table class="table mb-0" id="HmyTable">
											...
											<tr>
												<th scope="row"><?=$s+1;?></th>
												<td><input type="text" name="property_address[]" value="<?php if(empty($property_address[$s])){ echo ''; }else{ echo $property_address[$s] ;}?>" class="form-control" ></td>
												<td><input type="text" name="market_value[]" value="<?php if(empty($market_value[$s])){ echo ''; }else{ echo $market_value[$s] ;}?>" class="form-control" ></td>
												<td><input type="text" name="amt_outstanding[]" value="<?php if(empty($amt_outstanding[$s])){ echo ''; }else{ echo $amt_outstanding[$s] ;}?>" class="form-control" ></td>
												<td><input type="text" name="lenders_name[]" value="<?php if(empty($lenders_name[$s])){ echo ''; }else{ echo $lenders_name[$s] ;}?>" class="form-control" ></td>
												<td><input type="text" name="monthly_repayment[]" value="<?php if(empty($monthly_repayment[$s])){ echo ''; }else{ echo $monthly_repayment[$s] ;}?>" class="form-control" ></td>
												<td><input type="text" name="lb_loan_type[]" value="<?php if(empty($lb_loan_type[$s])){ echo ''; }else{ echo $lb_loan_type[$s] ;}?>" class="form-control" ></td>
								 ...
								 <h6 class="mb-0 text-uppercase" style="color:#1493ee;">Other Liabilities:</h6>
									<table class="table mb-0" id="LmyTable">
										...
										?>
											<tr>
												<th scope="row"><?=$l+1;?></th>
												<td><input type="text" name="ot_loan_type[]" value="<?php if(empty($ot_loan_type[$l])){ echo ''; }else{ echo $ot_loan_type[$l] ;}?>" class="form-control" ></td>
												<td><input type="text" name="ot_amt_borrowed[]" value="<?php if(empty($ot_amt_borrowed[$l])){ echo ''; }else{ echo $ot_amt_borrowed[$l] ;}?>" class="form-control" ></td>
												<td><input type="text" name="ot_amt_outstanding[]" value="<?php if(empty($ot_amt_outstanding[$l])){ echo ''; }else{ echo $ot_amt_outstanding[$l] ;}?>" class="form-control" ></td>
												<td><input type="text" name="ot_lenders_name[]" value="<?php if(empty($ot_lenders_name[$l])){ echo ''; }else{ echo $ot_lenders_name[$l] ;}?>" class="form-control" ></td>
												<td><input type="text" name="ot_monthly_repayment[]" value="<?php if(empty($ot_monthly_repayment[$l])){ echo ''; }else{ echo $ot_monthly_repayment[$l] ;}?>" class="form-control" ></td>
								 ...
								 <h6 class="mb-0 text-uppercase" style="color:#1493ee;">Credit Card:</h6>
									...
									<?php $i=0; foreach(explode("," ,$editdata->card_lender) as $array){ 
										...
										?>
											<tr>
												<th scope="row"><?=$i+1;?></th>
												<td><input type="text" name="card_lender[]" value="<?php if(empty($card_lender[$i])){ echo ''; }else{ echo $card_lender[$i] ;}?>" class="form-control" ></td>
												<td><input type="text" name="card_limit[]" value="<?php if(empty($card_limit[$i])){ echo ''; }else{ echo $card_limit[$i] ;}?>" class="form-control" ></td>
												<td><input type="text" name="card_amt_outstanding[]" value="<?php if(empty($card_amt_outstanding[$i])){ echo ''; }else{ echo $card_amt_outstanding[$i] ;}?>" class="form-control" ></td>
												</tr>
											<?php $i++; } ?>
										</tbody>
									</table>
								 ...
								 <h6 class="mb-0 text-uppercase" style="color:#1493ee;">Residential History for Last 3 Years:</h6>
									<table class="table mb-0" id="resTable">
										...
										?>
											<tr >
												<th scope="row"><?=$k+1;?></th>
												<td><input type="text" name="other_address[]" value="<?php if(empty($other_addressr[$k])){ echo ''; }else{ echo $other_addressr[$k] ;}?>" class="form-control" ></td>
												<td><input type="text" name="other_housingstatus[]" value="<?php if(empty($other_housingstatus[$k])){ echo ''; }else{ echo $other_housingstatus[$k] ;}?>" class="form-control" ></td>
												<td><input type="text" name="other_date_moved_in[]" value="<?php if(empty($other_date_moved_in[$k])){ echo ''; }else{ echo $other_date_moved_in[$k] ;}?>" class="form-control" ></td>
												<td><input type="text" name="other_date_moved_out[]" value="<?php if(empty($other_date_moved_out[$k])){ echo ''; }else{ echo $other_date_moved_out[$k] ;}?>" class="form-control" ></td>
							   ...
							   <div class="card-body">
									<h6 class="mb-0 text-uppercase" style="color:#1493ee;">Employment History for Last 3 Years:</h6>
										...
										?>
												<tr>
													<th scope="row"><?=$j+1;?></th>
													<td><input type="text" name="employer_name[]" value="<?php if(empty($employer_name[$j])){ echo ''; }else{ echo $employer_name[$j] ;}?>" class="form-control" ></td>
													<td><input type="text" name="employer_phone[]" value="<?php if(empty($employer_phone[$j])){ echo ''; }else{ echo $employer_phone[$j] ;}?>" class="form-control" ></td>
													<td><input type="text" name="occupation[]" value="<?php if(empty($occupation[$j])){ echo ''; }else{ echo $occupation[$j] ;}?>" class="form-control" ></td>
													<td><input type="date" name="job_start_date[]" value="<?php if(empty($job_start_date[$j])){ echo ''; }else{ echo $job_start_date[$j] ;}?>" class="form-control" ></td>
													<td><input type="date" name="job_end_date[]" value="<?php if(empty($job_end_date[$j])){ echo ''; }else{ echo $job_end_date[$j] ;}?>" class="form-control" ></td>
							...
							<div style="background-color: #f5f5f5;padding: 10px;">
										<div class="">
										 ...
										 <div class="">
											...
											<div class="form-check">
												<input class="form-check-input" style="box-sizing: border-box; border-radius: 1px;"  type="checkbox" value="yes" <?php if($editdata->terms_condition=="yes"){ echo 'checked';} ?>  name="terms_condition" id="flexRadioDefault1">
											...
											<div class="form-check">
												<input class="form-check-input" style="box-sizing: border-box; border-radius: 1px;"  type="checkbox" value="yes" <?php if($editdata->privacy_statement=="yes"){ echo 'checked';} ?> name="privacy_statement" id="flexRadioDefault1">
												<label class="form-check-label" for="flexRadioDefault1">I have reviewed, understood and consent to the Privacy Statement</label>
												
											</div>
											<div class="form-check">
												<input class="form-check-input" style="box-sizing: border-box; border-radius: 1px;" type="checkbox" value="yes" name="provide_app_omission" id="flexRadioDefault1" <?php if($editdata->provide_app_omission=="yes"){ echo 'checked';} ?>>
								...
								<div>
									<table>
										...
										<tr>
											...
											<td style="padding-left: 20px;"><input style="box-sizing: border-box; border-radius: 1px;" class="form-check-input" type="radio" name="agree_toload" <?php if($editdata->agree_toload=="yes"){ echo 'checked';} ?> id="serverYes" value="yes"></td>
											<td>Yes</td>
											<td style="padding-left: 20px;"><input style="box-sizing: border-box; border-radius: 1px;" class="form-check-input" type="radio" name="agree_toload" <?php if($editdata->agree_toload=="no"){ echo 'checked';} ?> id="serverNo" value="no"></td>
											<td>No</td>
								...
								<div>
									<table>
										...
										<tr>
											...
											<td style="padding-left: 20px;"><input style="box-sizing: border-box; border-radius: 1px; " class="form-check-input" type="radio" name="excellent_credit" <?php if($editdata->excellent_credit=="yes"){ echo 'checked';} ?> id="" value="yes"></td>
											<td>Yes</td>
											<td style="padding-left: 20px;"><input style="box-sizing: border-box; border-radius: 1px;" class="form-check-input" type="radio" name="excellent_credit" <?php if($editdata->excellent_credit=="no"){ echo 'checked';} ?> id="" value="no"></td>
											<td>No</td>
								...
								<div class="col-xl-6 mb-3">
									...
									<div class="col-xl-1 mb-3">
										...
										<input style="box-sizing: border-box; border-radius: 1px;" type="radio" name="cardit_legal_recorde" class="form-check-input" <?php if($editdata->cardit_legal_recorde=="yes"){ echo 'checked';} ?> value="yes">
									 </div>
                                     <div class="col-xl-1 mb-3">
										<label class="form-label">No</label>
										<input style="box-sizing: border-box; border-radius: 1px;" type="radio" name="cardit_legal_recorde" class="form-check-input" <?php if($editdata->cardit_legal_recorde=="no"){ echo 'checked';} ?> value="no">
									 </div>
								...
								<div class="col-xl-6 mb-3">
									...
									<div class="col-xl-1 mb-3">
										<label class="form-label">Yes</label>
										<input style="box-sizing: border-box; border-radius: 1px;" type="radio" name="commitments" class="form-check-input" <?php if($editdata->commitments=="yes"){ echo 'checked';} ?> value="yes">
									 </div>
                                     <div class="col-xl-1 mb-3">
										<label class="form-label">No</label>
										<input style="box-sizing: border-box; border-radius: 1px;" type="radio" name="commitments" class="form-check-input" <?php if($editdata->commitments=="no"){ echo 'checked';} ?> value="no">
									 </div>
									 <div class="col-xl-2 mb-3">
										<label class="form-label">Other</label>
								...
								<div class="col-xl-6 mb-3">
									...
									<div class="col-xl-1 mb-3">
										<label class="form-label">Yes</label>
										<input style="box-sizing: border-box; border-radius: 1px;" type="radio" name="anticipate_income" class="form-check-input" <?php if($editdata->anticipate_income=="yes"){ echo 'checked';} ?> value="yes">
									 </div>
                                     <div class="col-xl-1 mb-3">
										<label class="form-label">No</label>
										<input style="box-sizing: border-box; border-radius: 1px;" type="radio" name="anticipate_income" class="form-check-input" <?php if($editdata->anticipate_income=="no"){ echo 'checked';} ?> value="no">
									 </div>
									 <div class="col-xl-2 mb-3">
										<label class="form-label">Other</label>
