      ...
      <header class="top-header">        
        <nav class="navbar navbar-expand gap-3">
          <div class="mobile-toggle-icon fs-3">
            ...
            <!--              <img src="<?=base_url();?>assets/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="54" height="54">-->
            <!--              <div class="ms-3">-->
            ...
            <!--         <a class="dropdown-item" href="#">-->
            <!--           <div class="d-flex align-items-center">-->
            <!--              <img src="<?=base_url();?>assets/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="50" height="50">-->
            ...
            <!--        <a class="dropdown-item" href="#">-->
            <!--          <div class="d-flex align-items-center">-->
            <!--             <img src="<?=base_url();?>assets/images/avatars/avatar-2.png" alt="" class="rounded-circle" width="50" height="50">-->
            <!--             <div class="ms-3 flex-grow-1">-->
            ...
            <!--        <a class="dropdown-item" href="#">-->
            <!--          <div class="d-flex align-items-center">-->
            <!--             <img src="<?=base_url();?>assets/images/avatars/avatar-3.png" alt="" class="rounded-circle" width="50" height="50">-->
            <!--             <div class="ms-3 flex-grow-1">-->
            ...
            <!--        <a class="dropdown-item" href="#">-->
            <!--          <div class="d-flex align-items-center">-->
            <!--             <img src="<?=base_url();?>assets/images/avatars/avatar-4.png" alt="" class="rounded-circle" width="50" height="50">-->
            <!--             <div class="ms-3 flex-grow-1">-->
            ...
            <!--        <a class="dropdown-item" href="#">-->
            <!--          <div class="d-flex align-items-center">-->
            <!--             <img src="<?=base_url();?>assets/images/avatars/avatar-5.png" alt="" class="rounded-circle" width="50" height="50">-->
            <!--             <div class="ms-3 flex-grow-1">-->
            ...
            <!--        <a class="dropdown-item" href="#">-->
            <!--          <div class="d-flex align-items-center">-->
            <!--             <img src="<?=base_url();?>assets/images/avatars/avatar-6.png" alt="" class="rounded-circle" width="50" height="50">-->
            <!--             <div class="ms-3 flex-grow-1">-->
