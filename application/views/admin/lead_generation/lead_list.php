								...
								<tbody>
									...
									<tr>
										...
										<td id="statustd_<?=$row->id;?>">
										    ...
										    <select class="form-select mb-3" <?php if($row->status==2){ echo "style='background: #2d37afbf; color: #FFF;'";}else if($row->status==3){ echo "style='background: #009966; color: #FFF;'";}else if($row->status==4){ echo "style='background:#f9058ceb; color: #FFF;'";}else{ echo "style='background: #990000bf; color: #FFF;'";} ?> aria-label="Default select example" name="status" onchange="updatestatus(<?=$row->id ?>,this)">
										...
										<?php } else{?>
											<td id="statustd_<?=$row->id;?>">
										    <select class="form-select mb-3" <?php if($row->status==2){ echo "style='background: #2d37afbf; color: #FFF;'";}else if($row->status==3){ echo "style='background: #009966; color: #FFF;'";}else if($row->status==4){ echo "style='background:#f9058ceb; color: #FFF;'";}else{ echo "style='background: #990000bf; color: #FFF;'";} ?> aria-label="Default select example" name="status">
